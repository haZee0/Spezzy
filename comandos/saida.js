exports.run = async(client, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(`» Escreva abaixo a mensagem de saída`)
            ...
            let cj = message.channel.createMessageCollector(x => x.author.id == message.author.id, {
                ...
                .on('collect', c => {
                    ...
                    db.set(`lmessage_${message.guild.id}`, texto)
                    ...
                    message.channel.send(embed2).then(msg2 => {
                        ...
                        let cjj = message.channel.createMessageCollector(x => x.author.id == message.author.id, {
                            ...
                            .on('collect', c => {
                                ...
                                db.set(`ltitle_${message.guild.id}`, titulo)

                                const embed3 = new MessageEmbed()
                                    .setTitle(`__CANAL__`)
                                    .setColor('#206694')
                                    .setDescription(`» Por fim, mencione o canal que deseja definir como de saída`)
                                ...
                                message.channel.send(embed3).then(msg3 => {
                                    ...
                                    db.set(`lcanal_${message.guild.id}`, canal.id)

                                    message.channel.send({embed: {
                                        color: '#faa61a',
                                        description: `Pronto ${message.author}, sistema de saída configurado com sucesso!`
                                    }}) 
                            })
                        })
                    })
